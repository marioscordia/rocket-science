...
import (
	...
	"github.com/marioscordia/rocket-science/platform/pkg/grpc/health"
...
func (a *App) initGRPCServer(ctx context.Context) error {
	...
	userv1.RegisterUserServiceServer(a.grpcServer, a.diContainer.GRPCServer(ctx))

	return nil
}

func (a *App) runGRPCServer(ctx context.Context) error {
	logger.Info(ctx, fmt.Sprintf("🚀 gRPC UserService server listening on %s", config.AppConfig().GRPC.Address()))
