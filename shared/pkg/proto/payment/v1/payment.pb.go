...
const (
	PaymentMethod_PAYMENT_METHOD_UNSPECIFIED    PaymentMethod = 0 // Unknown payment method
	PaymentMethod_PAYMENT_METHOD_CARD           PaymentMethod = 1 // Bank card
	PaymentMethod_PAYMENT_METHOD_SBP            PaymentMethod = 2 // Fast Payment System (Sistema Bystrykh Platezhey)
	PaymentMethod_PAYMENT_METHOD_CREDIT_CARD    PaymentMethod = 3 // Credit card
	PaymentMethod_PAYMENT_METHOD_INVESTOR_MONEY PaymentMethod = 4 // Investor money (internal method)
)
...
// PayOrderRequest is the request message for PayOrder
type PayOrderRequest struct {
	...
	UserUuid      string                 `protobuf:"bytes,2,opt,name=user_uuid,json=userUuid,proto3" json:"user_uuid,omitempty"`                                               // User UUID who initiates the payment
...
// PayOrderResponse is the response message for PayOrder
type PayOrderResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	TransactionUuid string                 `protobuf:"bytes,1,opt,name=transaction_uuid,json=transactionUuid,proto3" json:"transaction_uuid,omitempty"` // Payment transaction UUID
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBNZLgithub.com/marioscordia/rocket-science/shared/pkg/proto/payment/v1;paymentv1b\x06proto3"
